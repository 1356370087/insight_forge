...
原始资料会快速耗尽上下文，并混入大量重复内容、工具错误和潜在提示注入。压缩摘要优先可以降低成本、提高注意力集中度；Artifact 回读则保留了追溯能力，形成冷热分层，而不是在"全量上下文"和"彻底丢弃原文"之间二选一。
...
工具结果门禁位于 Researcher 内部，负责**过程纠偏和预算控制**；Handoff 门禁位于 Agent 边界，决定整份SubAgent 结果能否进入共享状态。前者改善研究过程，后者才真正**阻断低质量信息跨 Agent 传播**。
