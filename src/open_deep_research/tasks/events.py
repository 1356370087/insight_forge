...
class EventType(str, Enum):
    ...
    TASK_MAILBOX_DELIVERY_FAILED = "task.mailbox_delivery_failed"
    MAILBOX_REDELIVERED = "mailbox.redelivered"
    MAILBOX_DEAD_LETTERED = "mailbox.dead_lettered"
    LEADER_LEASE_TAKEN_OVER = "leader.lease_taken_over"
